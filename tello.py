...
from tellopy._internal import crc, logger, event, state, error, video_stream, dispatcher
from tellopy._internal.utils import *
from tellopy._internal.protocol import *

log = logger.Logger('Tello')

class APTello(object):
    ...
    def __init__(self, comm_sock: socket.socket, vid_sock: socket.socket, ip: str):
        self.tello_addr = (ip, 8889)
        self.ip = ip
        self.debug = True
